          ...
          <div className="p-5">
            ...
            <div className="flex flex-col items-center mb-8">
              <div className="w-full aspect-video relative rounded-2xl overflow-hidden bg-gray-100 mb-6 shadow-sm">
                <Image
                  src={
                    config?.banner?.image_url || "/assets/images/affliate.jpg"
                  } // Đảm bảo đường dẫn đúng trong thư mục public
            ...
            <div className="bg-white p-6 rounded-3xl border border-gray-100 shadow-[0_8px_30px_rgb(0,0,0,0.04)] mb-6">
              ...
              <button
                onClick={handleShare}
                className="w-full bg-primary-color-2 text-white py-4 rounded-2xl flex items-center justify-center gap-2 font-bold text-lg "
              >
                <Share2 size={22} />
                {t("affiliate.share")}
              </button>
